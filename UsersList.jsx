      ...
      <div className="container text-white">
        <div className="col">
          ...
          <div className="col text-white mt-4  ">
            ...
            <div key={index} className=" col my-2  w-100  d-flex justify-content-between">
            <div className="w-100 ">
              <div className="row Black-div p-3 mb-4">
                ...
                <div className="col-lg col-md-12 mb-4">Here's the Username</div>
                <div className="col-lg col-6  d-none d-lg-block"  >
                  <button className="rounded-btn btn Default-bg text-white mb-2 hover-bg-color">
                    Active
                  </button>
                </div>
                <div className="col-6 d-md-block d-lg-none  mb-4">User ID</div>
                
                <div className="col-lg col-6">FE -2303</div>

                <div className="col-6 d-md-block d-lg-none  mb-4">Role</div>
                <div className="col-lg col-6">Student</div>
                <div className="col-6 d-md-block d-lg-none  mb-4">Email</div>
