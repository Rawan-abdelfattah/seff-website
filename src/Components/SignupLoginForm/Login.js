         ...
         <div className='row'>
            <div className='form-parent'>
                        ...
                        <div className='row mt-1'>
                          ...
                          <div className='col-12'>
                            ...
                            <div className='forget-password d-flex justify-content-end'>
                              <p><a className='text-decoration-none text-white' href='#'>Forget your password?</a></p>
                            </div>
                          </div>
                        </div>
                        <div className='row'>
              ...
              <div className='login-link mt-3'>
                 <p className='text-white account'>Don't have an account yet?<a href='/signup' className='text-decoration-none mx-2'>Sign up</a></p>
              </div>
            </div>
         </div>
      </div>
