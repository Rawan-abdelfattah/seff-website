          ...
          <div className="container">
            <div className="row ">
              <div className="col-lg-12 m-3">
                <p
                  className="text-white line-after   "
              ...
              <Row>
                ...
                <div
                  className="horizontal-scroll-container transition"
                  id="content"
                >
              ...
              <div className="jobs container  mt-4  m-auto">
                <div className="row d-flex justify-content-between m-3">
                  <div className="d-flex flex-column  justify-content-between  flex-lg-row mt-5 mb-4">
                    <p className="text-white   font-s-20 mb-5 ">
                      Other Courses
                    </p>
                    ...
                    <div className="row  p-3 mb-4">
                      <div className="my-2 d-none d-lg-block  ">
                        <div className="w-90 ">
                          <div className="row p-3">
                            ...
                            <div className="col-lg col-6 ms-4 fw-bold">
                              Level
                            </div>
                      ...
                      {records.map((items, index) => (
                        <div key={index} className="">
                          <div className="row p-3 ">
                            <div className="col-lg col-md-12 flex-column mb-4 ">
                            ...
                            <div className="col-lg-2 col-md-6  flex-column justify-content-end mb-4">
                              Thurasday, June 8th
                            </div>
                            <div className="col-lg col-md-6 flex-column justify-content-end mb-4 ">
                              LEV-1
                            </div>
                            <div className="col-lg   justify-content-end mb-4 ">
                              <button className="text-white w-100 pt-3 pb-3 button">
                                ENROLL
                              </button>
                            ...
                            <div className="col-lg   justify-content-end mb-4  text-end d-md-block d-lg-none">
